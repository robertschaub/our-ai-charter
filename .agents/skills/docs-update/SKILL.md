...
2. **README index.** Open the [README](../../../README.md). It presents **Our AI Charter / the Public AI Network** (this whole effort) — its overview, compute pillar, published articles, and the strategy/outreach/evidence — with **AI Assurance & Certification** as the trust sub-stream, each document's status labelled inline. Move or add the document to the right section with a one-line description that matches its current framing. Remove stale entries.
