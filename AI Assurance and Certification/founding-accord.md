...
- **Governance pack** (the credibility layer): define an internationally co-stewarded, capture-resistant standard steward, preferably hosted in or accountable to an existing neutral body, with firewalls so no single state, company, funder, host institution, assessor, or audited party can set criteria, select assessors, suppress findings, or control the registry; include funding caps + conflict-of-interest policy; independent board/assembly with Global-South & civil-society seats *by rule*; auditor accreditation; appeals/remediation; public audit + revocation history.
