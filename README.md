...
It is an early public draft proposing an **international network of open AI models** whose providers **would commit** to a **common charter of public obligations**. The proposal includes a **governance-and-evidence layer separate from service provision** so free societies could inspect and contest the systems they rely on. It is not affiliated with any existing Public AI coalition unless explicitly stated, and it is not a certification, standard, Trust Mark, registry, or active pilot.
...
- **[The Public AI We Need: Sovereign, Inspectable and Accountable](docs/Published/the-public-ai-we-need.md)** — *PUBLISHED* (2026-08-06). Synthesis of the ten earlier articles into one argument: sovereignty without autarky, the four public-AI pillars and the competence beneath them, the practical test for power and five obligations, two governance clocks and five action gates, separated accountability roles, empathy as correctable perspective, a bounded first substrate, and the Phase-1 boundary. Feed post, cover, and a grouped reading index of the earlier articles are included. [Article](https://www.linkedin.com/pulse/public-ai-we-need-sovereign-inspectable-accountable-robert-schaub-vskve) · [Post](https://www.linkedin.com/posts/robertschaub_publicai-digitalsovereignty-aiaccountability-ugcPost-7491102398682279936-Fhjz).
...
- **[When Should Runtime AI Governance Interrupt?](docs/Published/when-should-runtime-ai-governance-interrupt.md)** — *PUBLISHED* (2026-07-30). Companion to the *when vs. who* article: two connected clocks, five activity/gate pairs, machine-enforced entry and commitment boundaries, bounded authority, narrow escalation, and a sealed action record through review and remedy. Feed post, cover, and related public discussion mirrored. [Article](https://www.linkedin.com/pulse/when-should-runtime-ai-governance-interrupt-robert-schaub-mc2sc) · [Post](https://www.linkedin.com/posts/robertschaub_ai-trustworthyai-aigovernance-activity-7488606064989360129-JukJ).
- **[Our AI Charter: From Open Models to Accountable Public AI Infrastructure](docs/Published/our-ai-charter-public-ai-infrastructure.md)** — *PUBLISHED* (2026-07-28; revised 2026-07-30). Current project statement: four connected public-AI pillars, the broker-and-evidence layer, the runtime decision path, AI Assurance & Certification as the trust-and-evidence building block, an explicit Phase-1 boundary, and a bounded Geneva 2027 next step. Feed post and cover mirrored. [Article](https://www.linkedin.com/pulse/our-ai-charter-from-open-models-accountable-public-robert-schaub-qafie/) · [Post](https://www.linkedin.com/posts/robertschaub_publicai-aigovernance-digitalsovereignty-ugcPost-7487951694866345984-FPSP).
- **[The Swiss Autarky Illusion: Why Digital Sovereignty Cannot Be Built Alone](docs/Published/swiss-autarky-illusion.md)** ([DE](docs/Published/schweizer-autarkie-illusion.md)) — *PUBLISHED* (EN/DE, 2026-07-24). Autarky is not sovereignty: the 1940 Réduit as the warning image, Apertus honoured and honestly bounded (production evidence, investment gap, copyright→data cost), sovereignty recast as the ability to inspect, co-decide, contest, and switch — built in a values-bound public-AI federation, with the Federal Council's own sovereignty report as the domestic evidence. Both language editions and their feed posts are mirrored; the EN feed-post exchange and two related public comments (ICT4Peace/NCS input; the Durable Leverage Framework post) are documented. [EN post](https://www.linkedin.com/pulse/swiss-autarky-illusion-why-digital-sovereignty-cannot-robert-schaub-tiamc) · [DE post](https://www.linkedin.com/pulse/die-schweizer-autarkieillusion-warum-digitale-nicht-im-robert-schaub-1267e).
- **[Runtime AI Governance Gets *When* Right — the Harder Question Is *Who Gets to Check?*](docs/Published/when-vs-who-ai-governance.md)** — *PUBLISHED* (2026-07-23). Runtime checking answers *when* to govern; public accountability also needs independent evidence assessment, role-scoped inspection, and a real path for affected people to challenge decisions. Feed post and cover mirrored; comments documented. [Post](https://www.linkedin.com/pulse/runtime-ai-governance-gets-when-right-harder-question-robert-schaub-z6ahe/).
- **[A Practical Test for Power](docs/Published/a-practical-test-for-power.md)** — *PUBLISHED* (2026-07-19; partly updated on LinkedIn 2026-07-20). A human-centred test for every use of power: legitimacy, concrete consequences, safe disagreement and refusal, independent review, remedy, firm limits, and precise responsibility from everyday institutions to war. Post, article source, and cover mirrored. [Article](https://www.linkedin.com/pulse/practical-test-power-robert-schaub-va1we) · [Post](https://www.linkedin.com/feed/update/urn:li:ugcPost:7484672865079058433/).
- **[Trustworthy AI, Accountable to People](docs/Published/trustworthy-ai-accountable-to-people.md)** — *PUBLISHED* (2026-06-14; updated on LinkedIn 2026-06-19). Launch article, post, and certification-question comment. [Article](https://www.linkedin.com/pulse/trustworthy-ai-accountable-people-robert-schaub-42vje) · [Post](https://www.linkedin.com/posts/robertschaub_trustworthy-ai-accountable-to-people-activity-7471667943433646080-vmAn).
- **[The Public AI Network](docs/Published/the-public-ai-network.md)** — *PUBLISHED* (2026-06-22). International statement of the umbrella and its accompanying feed post. [Article](https://www.linkedin.com/pulse/public-ai-network-building-sovereignty-resilience-free-robert-schaub-ggpne) · [Post](https://www.linkedin.com/posts/robertschaub_publicai-aigovernance-digitalsovereignty-ugcPost-7474731926705283072-O1zl).
...
- **[Swissnex/Mercator fellowship plan](docs/Strategy/geneva-2027-swissnex-fellowship.md)** — *DRAFT*. Channel record of the time-boxed fellowship (application window closed 12 Jul 2026) and the channel-neutral, artifact-first plan that outlives it.
...
- **[Geneva 2027 channel demand](docs/Evidence/geneva-2027-channel-demand.md)** — *DRAFT*. What each Geneva 2027 channel — Swissnex fellowship, official process, the *Road to Geneva* pre-events track, Current AI, Apertus/SNAI — accepts as a contribution; re-verify before citing.
...
- **[Grounding-Faithfulness & Contestability](docs/Assurance/Protocol/grounding-faithfulness-and-contestability.md)** — *DRAFT v0.3*. First evaluation module; see also the [one-pager](docs/Assurance/Protocol/one-pager.md).
...
- **[Evidence-Gated Agents: aspiration and test](docs/Assurance/Concepts/evidence-gated-agents.md)** — *DRAFT, non-normative*. Mostly generic AI-derived evidence requirements, separate adequacy review, and a proposed evaluation of reliability, usefulness and enforcement.
- **[Evidence-Gated Agents — user needs and requirements](docs/wip/evidence-gated-agents-requirements.md)** — *WORKING NOTES, v0.1 draft*. User needs and requirements across prototype scope, possible extensions and research aspirations; baseline adoption pending.
- **[Evidence-Gated Agents — specification](docs/wip/evidence-gated-agents-spec.md)** — *WORKING NOTES, v0.1 draft*. Proposed behaviour and retained conformance constraints, with remaining contract gaps; baseline adoption pending.
