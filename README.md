...
- **[Die Schweizer Autarkie-Illusion: Warum digitale Souveränität nicht im Alleingang entsteht](docs/Published/schweizer-autarkie-illusion.md)** — *PUBLISHED* (DE, 2026-07-24). Autarky is not sovereignty: the 1940 Réduit as the warning image, Apertus honoured and honestly bounded (production evidence, investment gap, copyright→data cost), sovereignty recast as the ability to inspect, co-decide, contest, and switch — built in a values-bound public-AI federation, with the Federal Council's own sovereignty report as the domestic evidence. Feed post mirrored. [Post](https://www.linkedin.com/pulse/die-schweizer-autarkieillusion-warum-digitale-nicht-im-robert-schaub-1267e).
