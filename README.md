...
Published mirrors and translations of external articles, plus publication drafts kept under `docs/wip/` until the maintainer publishes them. Status is shown inline and, where required, in each page banner.

- **[Our AI Charter, One Month On: From Open Models to Accountable Public AI Infrastructure](docs/wip/our-ai-charter-one-month-on.md)** — *WORKING NOTES* (prepared 2026-07-28). LinkedIn-ready article, feed post, and cover updating the original project announcement: the Public AI Network as the urgent proposition, AI Assurance & Certification as its trust-and-evidence building block, the honest Phase-1 boundary, and a bounded Geneva 2027 next step.
