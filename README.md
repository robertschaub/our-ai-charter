...
- **[Federated public compute architecture](docs/Public%20AI%20Network/Strategy/federated-public-compute-architecture.md)** — *DRAFT*. The compute pillar, grounded: Apertus/PublicAI as the live starting anchor, federated/governed capacity, a civic-peering trust model, compute tiers, an evidence plane, anti-capture governance, and a Geneva 2027 compute-and-evidence MVP.
