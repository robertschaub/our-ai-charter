...
- **[Geneva 2027 — Swissnex/Mercator fellowship & recommended plan](docs/Public%20AI%20Network/Strategy/geneva-2027-swissnex-fellowship.md)** — *WIP / DISCUSSION*. The "Geneva Loading…" preparatory fellowship as a concrete on-ramp (SF immersion Nov 2026; official side-event slot Q2 2027; apply by 12 Jul 2026), and an artifact-first, rejection-proof plan around it.
...
- **[Grounding-Faithfulness & Contestability](docs/AI%20Assurance%20and%20Certification/Protocol/grounding-faithfulness-and-contestability.md)** — *WORKING DRAFT*. The first evaluation module ([one-pager](docs/AI%20Assurance%20and%20Certification/Protocol/one-pager.md)).
- **[How certification could work later](docs/AI%20Assurance%20and%20Certification/Framework/certification-model.md)** — *WORKING DRAFT*. The future assurance and accreditation structure.
