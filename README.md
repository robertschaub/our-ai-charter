...
- **[Geneva 2027 — contribution routes and partners](docs/Strategy/geneva-2027-options.md)** — *DRAFT*. The realistic routes into the Geneva AI Summit 2027 and the named actors who hold each piece.
- **[Geneva 2027 — Swissnex/Mercator fellowship & recommended plan](docs/Strategy/geneva-2027-swissnex-fellowship.md)** — *DRAFT*. The "Geneva Loading…" preparatory fellowship as a concrete on-ramp (SF immersion Nov 2026; official side-event slot Q2 2027; apply by 12 Jul 2026), and an artifact-first, rejection-proof plan around it.
- **[Digital-sovereignty motions (24.3209 + 26.3221)](docs/Strategy/digital-sovereignty-motions.md)** — *DRAFT*. How the two Council-of-States-adopted sovereignty motions open a window for the Charter / Public AI Network — 24.3209 as the structural anchor, 26.3221 as a funding/pilot vehicle — and what to watch as they concretise.
