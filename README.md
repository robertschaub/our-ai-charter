...
- **[The Public AI We Need: Sovereign, Inspectable and Accountable](docs/Published/the-public-ai-we-need.md)** — *PUBLISHED* (2026-08-06). Synthesis of the ten earlier articles into one argument: sovereignty without autarky, the four public-AI pillars and the competence beneath them, the practical test for power and five obligations, two governance clocks and five action gates, separated accountability roles, empathy as correctable perspective, a bounded first substrate, and the Phase-1 boundary. Feed post, cover, and a grouped reading index of the earlier articles are included.
