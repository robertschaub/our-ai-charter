> **Status: WIP / DISCUSSION** - historical mechanism synthesis; current specifications live in the linked working drafts.

# From Manifesto to Mechanism - Synthesis Note

_Shortened on 2026-06-16. This file preserves the durable conclusions from an earlier long research synthesis without duplicating the current article, Founding Accord, protocol, certification model, risk audit, or human-rights background._

Use the documents below as the current guidance. This note is orientation and traceability, not an adopted position and not a certification scheme.
...
- Which neutral host or coalition is the right first venue.
- Which duties belong in the common baseline and which become public-interest modules.
- What evidence depth is sufficient for each risk class: documented, evidence observed, implementation checked, or effectiveness tested.
- How to keep pilot evaluation affordable without making it superficial.
- How to handle confidential evidence, security details, and lawful restrictions while preserving public accountability.
- How to fund the work without creating pay-to-pass incentives or pricing out small, open, public-interest, and Global-South builders.

## What This File No Longer Does

This file no longer carries the detailed verification mechanism, candidate-host ranking, declaration crosswalk, 90-day plan, or source list. Those details either moved into the current documents linked above or remain open research questions. Cite the current documents, not this note, when describing the repository's active position.
