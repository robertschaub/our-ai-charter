...
Standing up an accreditation body — assessor training, recognition, registry, surveillance — takes a decade and tens of millions; a solo founder at 70% time would drown in overhead. **And there's a direct cautionary tale:** the **Swiss Digital Trust Label** (Swiss Digital Initiative) — a neutral-body Swiss trust label — couldn't sustain itself independently: it handed the label to SGS (Jan 2025) and dissolved its foundation (Mar 2025). A Swiss solo founder should not repeat that.
