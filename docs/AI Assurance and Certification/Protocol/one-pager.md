...
**Risk documentation and release assessment.** Every pilot or future audit should require a risk and vulnerability register for the assessed scope, and the provider should publish a privacy-preserving release risk assessment before a public claim (updated for material updates, incidents, and currentness checks). Its required fields and the assurance-depth labels are defined in the [Founding Accord](../Framework/founding-accord.md) (operational duty 3); raw user data, secrets, and exploit details stay out of the public report.
