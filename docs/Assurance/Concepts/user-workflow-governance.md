...
| **Verify** | sources resolve and are entitled to establish what they are used for, evidence checked, uncertainty carried forward | keep verifying; do not convert doubt into certainty, or an unattributed source into an established fact |
