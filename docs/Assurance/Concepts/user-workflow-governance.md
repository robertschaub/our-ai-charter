...
| **Verify** | sources resolve; where a claim class has an entitled source, the citation's standing is recorded; evidence checked, uncertainty carried forward | keep verifying; do not convert doubt into certainty, or an unattributed source into an established fact |
