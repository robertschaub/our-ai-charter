...
3. **Public-interest modules.** Additional modules test the Charter's distinctive concerns beyond ordinary compliance — factual grounding, contestability, coercive-control transparency, AI-app security, privacy and provenance, fairness, resource and public-access impacts, and the other public-interest module candidates set out in the [Charter Commitments](charter-commitments.md). Modules are optional only where the risk is not material to the assessed release. A module marked **not assessed** does not waive baseline duties, and a full Charter alignment claim cannot omit material modules.
...
That means an audit should not merely test outputs. It should require a documented **risk and vulnerability register** and a privacy-preserving **release risk assessment**, published before a public claim and kept current for the release — its required fields and the assurance-depth labels (documented, evidence observed, implementation checked, effectiveness tested, or not assessed) are defined in the [Charter Commitments](charter-commitments.md) (operational duty 3). The audit checks that the public assessment covers the required risk areas, matches the confidential evidence pack, and keeps protected evidence — raw user data, secrets, exploit details — out of the public summary.
...
## People competence is a separate assurance object

System or release assurance does not by itself establish a portable claim that the people operating, overseeing, assessing, or reviewing it are competent across contexts. It may provide bounded evidence of how an assigned person performs a defined role in that deployment. The current consolidated EU AI Act requires providers and deployers to take measures that support the development of AI literacy among people dealing with AI on their behalf, while expressly not requiring a guaranteed specific level for any individual ([Article 4](https://eur-lex.europa.eu/eli/reg/2024/1689/2026-07-27/eng)); for high-risk systems, deployers must assign human oversight to people with the necessary competence, training, authority, and support ([Article 26](https://ai-act-service-desk.ec.europa.eu/en/ai-act/article-26)). [ISO/IEC 17024:2026](https://www.iso.org/standard/17024) addresses certification of persons against defined competence requirements; it is distinct from management-system certification and from assurance of a particular AI release.

A defined scenario exercise can provide bounded evidence of how a person performs when evidence is incomplete, scope changes, and organisational pressure is present; the validity, scoring consistency, and transferability of that evidence still need to be established. [DAIGI's CAGL pathway](https://www.daigi.org/programs) is one current example of the simulation direction: as checked on 2026-09-10, its public [programme](https://www.daigi.org/programs) and [accreditation](https://www.daigi.org/accreditation) pages describe simulation-based, capability-gated training, credentials issued directly by DAIGI, and mapping to the EU AI Act, ISO/IEC 42001, and the NIST AI RMF. This illustrates why five claims must remain separate: **course completed; credential authentic; curriculum framework-aligned; competence independently assessed; the relevant personnel-certification scheme or credential is within an external accreditation scope.** None alone establishes the others. DAIGI is cited as a public example only; no affiliation, partnership, endorsement, accreditation, independent validation, or programme-quality judgment is claimed.

The Charter should not become a training provider or personnel-certification body. Its narrower role is to state which consequential roles require competence, authority, independence, and support; what evidence may substantiate those properties; and where a live exercise should observe whether the role performs as claimed. A system evaluation may record that bounded observation, but it should not silently turn it into a portable personal credential.
