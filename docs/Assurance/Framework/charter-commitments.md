...
_Draft v0.19 (2026-08-10). Open for comment._
...
- **Consequential-action assessment:** standardise the proposal, mandate, authority-basis, authority-chain, admissibility, source-admissibility, human-intervention, commitment, effect, and remedy fields; define tests for subdelegation, revocation propagation, complete mediation, parameter substitution, replay, escalation routing, timeout defaults, authorized decision-maker unavailability, unattributed or inadmissible evidence, monitoring feedback, and point-of-effect verification.
