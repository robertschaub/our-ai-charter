...
_Draft v0.17 (2026-07-30). Open for comment._
...
- **Consequential-action assessment:** standardise the proposal, mandate, authority-chain, admissibility, human-intervention, commitment, effect, and remedy fields; define tests for subdelegation, revocation propagation, complete mediation, parameter substitution, replay, escalation routing, timeout defaults, authorized decision-maker unavailability, monitoring feedback, and point-of-effect verification.
