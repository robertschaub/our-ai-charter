...
- **Consequential-action assessment:** standardise the proposal, mandate, authority-basis, authority-chain, admissibility, source-admissibility, human-intervention, commitment, effect, and remedy fields; define tests for subdelegation, revocation propagation, complete mediation, parameter substitution, replay, escalation routing, timeout defaults, authorized decision-maker unavailability, unattributed or non-entitled evidence, monitoring feedback, and point-of-effect verification. Two prerequisites for the evidentiary half are open and should not be assumed solved: how a rule **declares** that a decision requires a given fact, and how that declaration binds to the specific input said to establish it. Without both, a standing marker can be recorded but not enforced.
