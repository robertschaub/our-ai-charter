<!-- STAGING NOTES:
Changed: tightened to a one-page technical pitch; removed an unsupported novelty claim; restored calibration, citation-coverage, release-assessment, lifecycle, and independence safeguards from the full protocol; focused the collaboration ask on a runnable pilot recipe. Robert confirmed the visible FactHarbor paused-alpha boundary stays.
