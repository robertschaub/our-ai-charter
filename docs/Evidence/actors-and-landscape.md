...
- **[Current AI](https://www.currentai.org/about-us)** — a multistakeholder public-interest-AI partnership launched at the 2025 Paris AI Action Summit (governments + philanthropies + companies); Switzerland is a Country Partner. **Joshua Tan (Public AI / Metagov, below) serves as interim CTO** — a personnel link between Current AI and the Public AI network.
