...
flowchart TB
  ...
  CH["<b>publicai.ch · SPIU</b><br/>Swiss cooperative in formation<br/>statutory founding 11 Aug 2026"]
...
| Oleg Lavrovsky | [Datalets.ch](https://datalets.ch/); Opendata.ch Advisory Board, Bern; **community manager, EPFL AI Center** (supporting the Swiss AI Initiative — [EPFL page](https://people.epfl.ch/oleg.lavrovsky?lang=en)) | Trustee of founding-member dues for **Public AI Switzerland (publicai.ch / SPIU)**; deploys Apertus at public events — operational Swiss anchor of the network, now also institutionally inside the Apertus cluster | ★★★★★ |
| Sabine Wildemann | Founding co-host publicai.ch — **no longer on its team page as of 2026-07-27, no reason stated**; Opendata.ch board; Liip; pres. aiLights, Zürich | Co-host publicai.ch founding (26–27 Feb 2026); co-initiator Swiss {ai} Weeks — convening node: open data + public sector; re-verify her publicai.ch role before outreach | ★★★★★ |
...
- **publicai.ch** has no formal board or member list published (a board vote was on the Feb 2026 meeting agenda, minutes unpublished; the statutory founding assembly is set for 11 Aug 2026); team as listed 2026-07-27: Sotnikova, Wolfenstädter, Höhener, Tan, Lavrovsky, Kanduri. Shared inbox `hello@publicai.co`.
