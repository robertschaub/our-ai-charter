...
**What the synthesis rewards:** overwhelming demand to **"move beyond declarations"** and produce **concrete, internationally reusable deliverables** — named explicitly: governance toolkits, audit/transparency templates, model cards, incident-reporting formats, provenance tracking, red-teaming protocols, **evaluation benchmarks, certification/trust labels,** an "accountability architecture reference standard for AI-assisted decisions in regulated sectors," and **"tools to measure how AI systems may be skewed or manipulative before political decisions."** Apertus is prominent in the surrounding Swiss public-AI discourse, but a 2026-07-03 re-check could not confirm that the prep report itself names Apertus; do not cite it as an official summit example without re-verification. Recommended model: federated, multilingual thematic workstreams with regional pre-events and common output formats.
