...
| **UN Independent International Scientific Panel on AI** — https://www.un.org/independent-international-scientific-panel-ai/en | Global scientific evidence body for AI policy. | Align the Charter with independent evidence and correction. |
| **UN Global Dialogue on AI Governance** — https://www.un.org/global-dialogue-ai-governance/en | Standing global forum for inclusive AI governance dialogue. | Offer a practical bottom-up contribution: a way for public-AI projects to show evidence of trustworthiness, not only make policy declarations. |
