...
- **Geneva AI Summit 2027 — next global AI summit, Switzerland as host:** Successor in the AI Action/Impact Summit series (Bletchley 2023 → Seoul 2024 → Paris 2025 → New Delhi 2026 → **Geneva, 21–22 June 2027** → UAE 2028); announced by Federal President Guy Parmelin at the New Delhi summit (19 Feb 2026). Organised jointly by **UVEK** (parent department of BAKOM) and **EDA**; EDA project lead **Amb. Markus Reubi**, with **Amb. Thomas Schneider (BAKOM/OFCOM)** representing Switzerland in international AI bodies. Switzerland frames itself as neutral convenor and a sectoral "middle way" between the EU AI Act and lightly-regulated approaches. Preparation underway: invite-only roundtable 1 Apr 2026 and an open written call whose findings went to the *Plateforme Tripartite* on 13 Apr 2026; the next input window is not yet publicly dated. (The "consultation draft due end-2026" sometimes cited is the *separate* Council of Europe AI Convention domestic implementing-law track — FDJP with DETEC/FDFA — not the summit.) NB: distinct from the annual ITU "AI for Good" Geneva summit. [[12]](#source-12)[[18]](#source-18)[[19]](#source-19)[[20]](#source-20)
