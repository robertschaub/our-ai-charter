...
- For a **domestic policy sprint**, lead with the goal as an **international network of open, charter-bound AI models** that Switzerland can catalyse with a **national impulse** — keep the vehicle (a policy sprint, an impulse programme in the sense of Motion 26.3221, or another) deliberately **open**, not pre-set as the goal (Switzerland as hub and coordinator; the coordinating role is aspired/earned, not a mandate claimed today — framed positively: international standing and economic strength follow from the role). Keep the harder **capture-resistance / branded "Public AI"** wording light and reserved for the **Geneva-2027 track**; as a headline it reads as too geopolitically loaded.
