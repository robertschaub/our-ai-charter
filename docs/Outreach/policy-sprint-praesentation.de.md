...
# Policy-Sprint-Präsentation: ein internationales Netzwerk offener KI-Modelle mit gemeinsamer Charta

*Kurzpräsentation und Handout für ein Policy-Sprint-Scoping (z. B. mit einem neutralen Convenor wie Expedition Zukunft). Englische Fassung: [sprint presentation (EN)](policy-sprint-presentation.en.md) · projektierbare Folien: [DE](policy-sprint-slides.de.html) / [EN](policy-sprint-slides.en.html). Knappe Fassung: [1-Pager](policy-sprint-1pager.de.md) · ausführliche Rahmung: [Non-Paper](non-paper.de.md).*
...
## 5 · Bausteine (Diskussionsgrundlage)
...
Eckwerte · Trägerschaft · Governance-/Charta-Grundzüge · Auswahl-/Förderkriterien · Postulat/Interpellation oder Vorbereitungsmandat für einen Pre-Sprint.
