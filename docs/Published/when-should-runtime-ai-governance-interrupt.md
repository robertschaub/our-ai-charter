...
Accountability must not become ambient surveillance. The record's subject is the action and its authority, not every token or the whole conversation. Access is role-scoped and logged. The Charter's [split-custody proposal](../Assurance/Concepts/split-custody-per-action-records.md) separates content, integrity, survivability, and access.
