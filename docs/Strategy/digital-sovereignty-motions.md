# Swiss digital-sovereignty motions (24.3209 + 26.3221)

Two digital-sovereignty motions adopted by the Council of States are now before the National Council. Together they show a forming, cross-party mandate for sovereign, open AI. Both focus on **building** capability; neither defines the governance and evidence layer that would keep publicly funded AI inspectable, accountable, and capture-resistant.

Full record and sources: [Verified Findings → Live political window](../Evidence/verified-findings.md#live-political-window).

## 24.3209 — structural / legislative anchor
...
5. **Formal thread later:** a carrier council member could file an interpellation/postulate once a coalition and concrete deliverable exist.

## Constraints

- Neither motion is finally adopted.
- There is no live funding call, budget, lead office, or selection process.
- Do not imply endorsement, coalition, selected-pilot status, or conflict with SNAI/Apertus.
- A non-parliamentarian engages only indirectly through a council member.
...
- Whether either motion is folded into the **Swiss AI Action Plan** governance track.
