...
2. **Produce the blueprint — Route C.** A neutral pre-sprint turns the idea into a memo others can carry. The **domestic cross-party sprint** now leads with the goal itself — a **national impulse programme for an international network of open, charter-bound AI models** with Switzerland as hub, coordination as the aspired network role (motion-anchored — see [action plan](../Outreach/action-plan.en.md)); positive framing (host, resilience, self-determination) carries the headline. Keep the harder **capture-resistance / co-stewardship** wording as separate, Geneva-framed detail.
