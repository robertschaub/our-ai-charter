...
> **Where this stands today.** This proposed public-AI network is an **early-stage, voluntary** design. No operational network access portal, admission body, assessor, adjudicator, public register, certificate, trust badge, or live evaluation pilot exists yet. No model or provider is Charter-certified. What exists is the proposal, the public drafts, and prospective partners. Taking part today means contributing, testing the case, or registering interest in a role — not endorsement or certification.
