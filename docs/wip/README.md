...
- **[runtime-gates-poc-spec.md](runtime-gates-poc-spec.md)** — implementation specification and delivery plan for a runnable POC of the five runtime gates (custom control plane; two user-selectable acting models — Apertus via the Public AI Inference Utility + GPT — with model switching as a governed, recorded transition; deterministic rules + evidence-only LLM screening; escalation console; hash-chained records); the code goes to the separate public repo `ai-charter-runtime` — this repo stays documentation-only.
