...
- **[public-ai-gaps-table.md](public-ai-gaps-table.md)** — **forwardable gaps table** distilled from the deep-dive: twelve checkable gaps across operations, claims, and data residency, each with public evidence, a status grade (several self-identified by Public AI), and a provider-neutral "what would close it" — written to be shared with the Public AI team as ally input.
