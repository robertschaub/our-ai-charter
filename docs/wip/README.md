...
- **[empathy-is-a-practice.md](empathy-is-a-practice.md)** — proposed article and LinkedIn post: defines empathy under power as dialogue, iteration, and transparent correction; applies **test every use of power** at individual and population scale; and keeps the human or institution using AI answerable.
- **[how-to-build-ai-that-acts-with-empathy.md](how-to-build-ai-that-acts-with-empathy.md)** — companion builder article and LinkedIn post: maps empathic behaviour and the companion practice across system layers, then specifies dialogue state, five-gate triggers, interruption modes, evidence, fallbacks, and responsibilities through training, runtime adaptation, and governed improvement.
