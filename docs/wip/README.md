...
- **[runtime-gates-poc-spec.md](runtime-gates-poc-spec.md)** — implementation specification and delivery plan for a runnable POC of the five runtime gates (custom control plane, Apertus-first pluggable acting model, deterministic rules + evidence-only LLM screening, escalation console, hash-chained records); the code goes to a separate public repo — this repo stays documentation-only.
