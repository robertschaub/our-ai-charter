...
- **[public-ai-what-they-build.md](public-ai-what-they-build.md)** — the **deep-dive on what Public AI actually builds and operates**: three operating layers (coalition / Metagov-hosted inference utility / chapter experiments), blueprint-vs-built mapping, the verified serving architecture and live compute lanes, the six-country model catalog, the Swiss cooperative's legal and membership reality, the complete disclosed funding picture, a 2023→2026 timeline, and a claims audit — with diagrams.
