...
- **[empathy-is-a-practice.md](empathy-is-a-practice.md)** — proposed article and LinkedIn post: makes empathy a socio-technical architectural requirement rather than simulated warmth; applies **test every use of power** at individual and population scale; and gives builders a concrete blueprint for grounding, dialogue, phase-specific training and tuning, consent-controlled adaptation, governed model updates, human evaluation, and firm red lines.
