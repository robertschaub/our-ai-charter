...
- **[runtime-gates-poc-spec.md](runtime-gates-poc-spec.md)** — implementation specification and delivery plan for a runnable POC of the five runtime gates (custom control plane; two user-selectable acting models — Apertus via the Public AI Inference Utility + GPT — with model switching as a governed, recorded transition; deterministic rules + evidence-only LLM screening; case + governance consoles with escalation inbox, mandate control, and record viewer; model selection via find → check → use over signed model cards; hash-chained records; FactHarbor-aligned licensing); the code goes to the separate public repo `ai-charter-runtime` — this repo stays documentation-only.
- **[justice-tree-vbe-charter-crosswalk.md](justice-tree-vbe-charter-crosswalk.md)** — public-source comparison of JusticeTree's Validation Before Execution™ design and the Charter runtime model: concept and outcome mappings, one shared synthetic benefit-suspension case, seventeen comparison fixtures, unresolved questions, minimum evidence deliverables, and attribution/IP boundaries; no endorsement, affiliation, or operational-interoperability claim.
