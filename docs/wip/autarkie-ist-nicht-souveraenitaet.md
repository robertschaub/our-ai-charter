...
## Apertus zeigt beides — Stärke und Grenze

Am konkreten Schweizer Fall lässt sich das durchbuchstabieren. [Apertus](https://www.swiss-ai.org/apertus) ist ein Erfolg: ein vollständig offenes Modell — Gewichte, Daten, Trainingsrezept — von EPFL, ETH Zürich und CSCS, mit Trainingsdaten aus 1'811 Sprachen, seit dieser Woche in [Version 1.5](https://www.cscs.ch/science/computer-science-hpc/2026/apertus-15-building-the-next-generation-of-open-ai-infrastructure) mit Bild- und Audioverständnis, dazu eine Familie kompakter Mini-Modelle. Der Kanton Tessin [übersetzt heute amtliche Dokumente](https://www.cscs.ch/science/computer-science-hpc/2026/apertus-powers-in-house-ai-translation-for-ticino) mit einem feinjustierten Apertus — ohne dass Daten die eigene Infrastruktur verlassen. Das ist gelebte digitale Selbstbestimmung.

Aber Apertus allein trägt die Souveränitätserwartung nicht, die ihm öffentlich aufgeladen wird — und die Fakten dazu sind keine Schande, sondern Klärung:

**Erstens, die Leistungsrealität.** Die Digitalagentur Liip hat acht Monate Produktionsbetrieb ihres Zürcher Verwaltungs-Chatbots [offen ausgewertet](https://www.liip.ch/en/blog/apertus-after-8-months-what-we-learned-and-look-forward-using-switzerlands-ai-model): Bei der Grundfrage «ist die Antwort akzeptabel?» liegt Apertus-70B mit 82 zu 81 Prozent gleichauf mit GPT-4o-mini — wobei Apertus auf einer kleineren offenen Parallelinstanz lief, das Kommerzmodell im grossen Produktivbetrieb. Hebt man die Messlatte auf «ist die Antwort wirklich gut?», öffnet sich die Lücke: 55 zu 72 Prozent. Bei der Quellentreue — bleibt die Antwort bei den Dokumenten, statt Plausibles zu erfinden? — steht es 0.50 zu 0.79. Und das gegen ein älteres, günstiges Kommerzmodell, nicht gegen die Spitze. Liip nennt das ausdrücklich einen Praxisbericht, keine Studie, und die Kurve zeigt aufwärts. Doch die Grössenordnung ist ehrlich benannt. Bemerkenswert: Die Apertus-Macher selbst positionieren das Projekt [gar nicht als Frontier-Konkurrenz](https://www.cscs.ch/science/computer-science-hpc/2026/apertus-15-building-the-next-generation-of-open-ai-infrastructure), sondern als vertrauenswürdige, transparente Basis, auf der Organisationen aufbauen können.

**Zweitens, die Investitionsrealität.** Für die nächste Ausbaustufe von Apertus stehen [20 Millionen Franken Bundesmittel](https://www.swissinfo.ch/eng/swiss-ai/fact-and-fiction-about-the-swiss-ai-model-apertus/90110034) bereit. Allein die vier grössten US-Technologiekonzerne planen für 2026 [Investitionen von über 700 Milliarden Dollar](https://www.cnbc.com/2026/02/06/google-microsoft-meta-amazon-ai-cash.html), massgeblich getrieben vom Ausbau der KI-Infrastruktur. Das ist kein Argument gegen öffentliche Investitionen; es ist das Ende der Illusion, ein nationales Budget könne diese Lücke im Alleingang schliessen.
...
Was heisst das konstruktiv? Vier Bausteine, die kein Land allein bauen muss — und keines allein bauen kann:

1. **Gemeinsame Standards und Interoperabilität**, damit sich die öffentlichen Modelle vieler Länder — von [Apertus](https://www.swiss-ai.org/apertus) über [OLMo](https://allenai.org/olmo) bis [EuroLLM](https://eurollm.io/) — zu einer Infrastruktur addieren, statt als Insellösungen zu fragmentieren.
2. **Eine öffentliche Evidenz- und Governance-Schicht:** Vertrauen entsteht nicht durch das Etikett «Made in Switzerland», sondern durch prüfbare Belege über reales Systemverhalten, klare Verantwortlichkeiten und Schutz vor politischer wie kommerzieller Vereinnahmung — und durch die Möglichkeit der Betroffenen, Entscheide [prüfen zu lassen und anzufechten](https://www.linkedin.com/pulse/runtime-ai-governance-gets-when-right-harder-question-robert-schaub-z6ahe).
3. **Gemeinsame Daten-Grundlagen:** Rechteklärung, Provenienz und Opt-out-Handling einmal lösen und vielfach nutzen — die COMMUNIA-Studie fordert dafür zu Recht einen europäischen öffentlichen Trainingskorpus als Infrastruktur — statt dass jedes Team denselben Rechtsberg allein besteigt.
4. **Gepoolte Rechenleistung und Modellpluralität:** mehrere offene Modelle und Rechenstandorte als gegenseitige Absicherung. Fällt eines aus — technisch, politisch oder ökonomisch —, trägt der Verbund. Genau das ist Resilienz.
...
Der Bundesrat dokumentiert beides gleich selbst — die richtige Diagnose und die fehlende Konsequenz. Sein [Bericht zur digitalen Souveränität](https://cms.news.admin.ch/fileservice/sdweb-docs-prod-nsbcch-files/files/2025/11/26/271b6aa0-8b5c-4ce8-b6ef-7f2443b0d86d.pdf) vom November 2025 definiert sie treffend als erforderliche «Kontroll- und Handlungsfähigkeit» des Staates. Er behandelt Autarkie zwar als mögliche, aber teuerste Antwort auf besonders kritische Abhängigkeiten — und hält es selbst mit hohem Finanzaufwand für «kaum realistisch», dass ein hochintegriertes Land wie die Schweiz in allen relevanten Bereichen eigene digitale Ressourcen bereitstellt. Als Alternativen nennt er Multi-Vendor-Ansätze, Exit-Strategien, rechtliche Vorkehrungen und völkerrechtliche Mittel gegen geopolitische Risiken.

Doch das politische Ergebnis bleibt weit hinter dem Auftrag zurück. Das [Postulat 22.4411](https://www.parlament.ch/de/ratsbetrieb/suche-curia-vista/geschaeft?AffairId=20224411) verlangte eine umfassende Strategie von staatspolitischer, wirtschaftlicher und gesellschaftlicher Bedeutung — einschliesslich Aussagen zur Bereitstellung der nötigen Mittel. Entstanden sind vor allem eine befristete Arbeitsgruppe, Übersichten, Risikoanalysen und Empfehlungen — kein Investitionsprogramm für eigene oder gemeinsam getragene digitale Handlungsfähigkeit.
