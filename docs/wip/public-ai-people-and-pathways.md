...
- **Swiss side:** the Public AI chapter is **publicai.ch / SPIU**, a cooperative in formation (draft statutes dated **11 Aug 2026**, notarised founding + register entry pending; team listed 2026-07-27: Sotnikova, Wolfenstädter, Höhener, Tan, Lavrovsky, Kanduri — **Wildemann, the founding co-host, is no longer listed**); **Apertus** sits in the **Swiss AI Initiative** (ETH + EPFL AI Centers, CSCS) with leads **Bosselut / Schlag / Jaggi**, and **Lavrovsky is now also EPFL AI Center community manager** — a dual-role personnel bridge between the chapter and the Apertus cluster.
...
flowchart TB
  ...
  subgraph CHX["Public AI Switzerland — publicai.ch / SPIU<br/>cooperative in formation · draft statutes dated 11 Aug 2026"]
    direction LR
...
**Update 2026-07-27/28:** people-state refresh from the [what-they-build deep-dive](public-ai-what-they-build.md): the cooperative's draft statutes are dated **11 Aug 2026** (notarised founding — required for cooperatives since 2023 — and register entry pending; no constitutive-assembly notice or founder list public); the publicai.ch team page changed (Wildemann no longer listed, no reason stated; new names Sotnikova, Wolfenstädter, Höhener, Kanduri); **Lavrovsky is also EPFL AI Center community manager** (a dual-role personnel bridge, reflected in §1/§3); Jackson's own site leads with OpenFn; the Fellow (Switzerland) posting was still listed with no public appointee announcement — earlier "open role" phrasings in this note now carry that date.
