> **Status: WORKING NOTES** — derived from the [federated public compute architecture](../Architecture/federated-public-compute-architecture.md) note and a GPT-5.5 cross-model review (2026-06-28); citations web-verified. Promotable to a `DRAFT` Outreach/Strategy one-pager once a carrier group exists.
