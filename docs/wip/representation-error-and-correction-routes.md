...
The Charter's own question in reply — who performs the reassessment when the body that would revalidate the authority is the body relying on it — was put publicly under the second post on 2026-08-06.
