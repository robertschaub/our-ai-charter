> **Status: WORKING NOTES** — prototype (2026-06-28). Third worked obligation→duty bridge, testing the instrument in [charter-structure-and-views.md](../Concepts/charter-structure-and-views.md) on the **technical-assurance** obligation. Pointer-level; routes to the [Accord](../AI%20Assurance%20and%20Certification/Framework/founding-accord.md)'s duties, inventing no new controls.
